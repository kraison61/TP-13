  ...
  <div class="relative mx-auto max-w-7xl px-6 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
    ...
    <div class="relative">
      <div class="relative aspect-4/5 overflow-hidden rounded-2xl shadow-2xl shadow-navy-900/30">
        ...
        <img src="https://pub-68154224aa0d447b83de9bf218e76277.r2.dev/images/about/194911_0.jpg" alt="{{ config('company.founder_name') }} ผู้ก่อตั้งธีรพงษ์เซอร์วิส" class="h-full w-full object-cover" />
  ...
  <div class="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
    <div class="lg:col-span-5 lg:sticky lg:top-28">
      ...
      <div class="mt-8 flex items-center gap-4 p-5 rounded-2xl bg-surface border border-line">
        ...
        <img src="https://pub-68154224aa0d447b83de9bf218e76277.r2.dev/images/about/TP.jpg" alt="{{ config('company.founder_name') }}" class="w-14 h-14 rounded-xl object-cover shrink-0" />
        <div>
  ...
  <div class="rounded-2xl border border-line bg-white overflow-hidden">
    <div class="grid lg:grid-cols-5 gap-0">
      <div class="lg:col-span-2 relative aspect-4/3 lg:aspect-auto overflow-hidden">
        ...
        <img src="https://pub-68154224aa0d447b83de9bf218e76277.r2.dev/images/about/family-01.webp" alt="{{ config('company.founder_name') }}" class="absolute inset-0 w-full h-full object-cover" />
      </div>
