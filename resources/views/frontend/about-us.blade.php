    ...
    <div>
      ...
      <div class="mt-8">
        <div class="flex flex-wrap gap-3">
          <a href="{{ route('home') }}#contact" class="inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3.5 font-semibold text-white shadow-lg shadow-navy-900/20 hover:bg-navy-900 transition">ส่งรูปให้ประเมินเบื้องต้นฟรี <x-icon name="arrow-right" /></a>
        ...
        <p class="mt-2.5 text-sm text-muted"><x-icon name="shield-check" class="text-accent mr-1 inline-block" />ประเมินฟรี · ไม่มีค่าใช้จ่าย · ไม่ผูกมัด · ตอบกลับภายใน 24 ชม.</p>
      </div>
    </div>
    <div class="relative">
      ...
      <div class="absolute -left-4 top-8 hidden sm:flex items-center gap-3 rounded-xl bg-navy-900 p-3 pr-4 shadow-xl ring-1 ring-navy-800">
        <span class="grid place-items-center w-10 h-10 rounded-lg bg-hivis/20 text-hivis text-lg"><x-icon name="patch-check-fill" /></span>
        <div>
          <div class="font-mono font-bold text-hivis leading-none tabular-nums">0</div>
...
<div class="border-y border-line bg-white">
  <div class="mx-auto max-w-7xl px-6 py-7 flex flex-wrap items-center justify-between gap-4">
    ...
    <div class="flex flex-wrap gap-2.5">
      <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[15px] text-ink2"><x-icon name="patch-check-fill" class="text-accent" /> ไม่ทิ้งงานเด็ดขาด</span>
      <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[15px] text-ink2"><x-icon name="eye-fill" class="text-accent" /> ราคาตามจริง ไม่มีแอบแฝง</span>
      <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[15px] text-ink2"><x-icon name="box-seam-fill" class="text-accent" /> วัสดุตรงสเปก</span>
      <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[15px] text-ink2"><x-icon name="chat-dots-fill" class="text-accent" /> คุยง่าย ตอบตรง</span>
      <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[15px] text-ink2"><x-icon name="box2-heart-fill" class="text-accent" /> ครบจบในทีมเดียว</span>
    </div>
  </div>
</div>
  ...
  <div class="mx-auto max-w-7xl px-6 py-20 lg:py-24">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 rounded-2xl overflow-hidden">
      <div class="bg-navy-900 p-7">
        <div class="font-mono text-5xl font-bold tracking-tight tabular-nums">{{ config('company.experience_years') }}<span class="text-hivis ml-1">ปี</span></div>
        <div class="mt-2 text-white/55">{{ config('company.experience_label') }}</div>
      </div>
      <div class="bg-navy-900 p-7">
        <div class="font-mono text-5xl font-bold tracking-tight tabular-nums">{{ config('company.projects_completed') }}<span class="text-hivis ml-1">งาน</span></div>
        <div class="mt-2 text-white/55">รับเหมาก่อสร้างที่ส่งมอบเรียบร้อย ตั้งแต่ถมดินจนถึงกำแพงกันดิน</div>
      </div>
      <div class="bg-navy-900 p-7">
        <div class="font-mono text-5xl font-bold tracking-tight tabular-nums">0<span class="text-hivis ml-1">งาน</span></div>
        <div class="mt-2 text-white/55">ที่เคยถูกทิ้ง — และเราตั้งใจรักษาสถิตินี้ตลอดไป</div>
      </div>
      <div class="bg-navy-900 p-7">
        <div class="font-mono text-5xl font-bold tracking-tight tabular-nums">100<span class="text-hivis ml-1">%</span></div>
        <div class="mt-2 text-white/55">ประเมินราคาตามจริง ไม่มีค่าใช้จ่ายแอบแฝง</div>
      </div>
      <div class="bg-navy-900 p-7">
        <div class="font-mono text-5xl font-bold tracking-tight tabular-nums">1<span class="text-hivis ml-1">ทีม</span></div>
      ...
      <div class="relative pl-8 border-l-2 border-line space-y-0">
        ...
        <div class="relative pb-10">
          ...
          <div class="ml-6">
            ...
            <h3 class="font-bold text-navy-900"><x-icon name="wrench-adjustable" class="text-accent mr-1.5 inline-block" />เด็กติดรถ — จุดเริ่มต้นของความหลงใหล</h3>
        ...
        <div class="relative pb-10">
          ...
          <div class="ml-6">
            ...
            <h3 class="font-bold text-navy-900"><x-icon name="truck" class="text-accent mr-1.5 inline-block" />พนักงานควบคุมเครื่องจักร</h3>
        ...
        <div class="relative pb-10">
          ...
          <div class="ml-6">
            ...
            <h3 class="font-bold text-navy-900"><x-icon name="cone-striped" class="text-accent mr-1.5 inline-block" />ผู้รับเหมารายเล็ก — ถมดิน เคลียริ่ง</h3>
        ...
        <div class="relative">
          <span class="absolute -left-[calc(1rem+1px)] top-1 w-8 h-8 rounded-full bg-hivis text-navy-900 grid place-items-center text-sm font-bold ring-4 ring-white"><x-icon name="flag-fill" class="text-xs" /></span>
          <div class="ml-6">
            ...
            <h3 class="font-bold text-navy-900"><x-icon name="bricks" class="text-accent mr-1.5 inline-block" />ผู้เชี่ยวชาญกำแพงกันดิน ถมดิน และรั้ว</h3>
  ...
  <div class="mx-auto max-w-7xl px-6 py-20 lg:py-28">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      <div class="rounded-2xl border border-line bg-white p-7 hover:border-navy-900 hover:-translate-y-1 hover:shadow-2xl hover:shadow-navy-900/10 transition">
        <span class="grid place-items-center w-14 h-14 rounded-xl bg-accent/8 text-accent text-2xl mb-5"><x-icon name="patch-check-fill" /></span>
        <h3 class="font-bold text-navy-900">รับผิดชอบจนงานจบ — ไม่ทิ้งงานเด็ดขาด</h3>
      ...
      <div class="rounded-2xl border border-line bg-white p-7 hover:border-navy-900 hover:-translate-y-1 hover:shadow-2xl hover:shadow-navy-900/10 transition">
        <span class="grid place-items-center w-14 h-14 rounded-xl bg-accent/8 text-accent text-2xl mb-5"><x-icon name="chat-heart-fill" /></span>
        <h3 class="font-bold text-navy-900">คุยง่าย เป็นกันเอง เหมือนญาติทำให้</h3>
      ...
      <div class="rounded-2xl border border-line bg-white p-7 hover:border-navy-900 hover:-translate-y-1 hover:shadow-2xl hover:shadow-navy-900/10 transition">
        <span class="grid place-items-center w-14 h-14 rounded-xl bg-accent/8 text-accent text-2xl mb-5"><x-icon name="shield-fill-check" /></span>
        <h3 class="font-bold text-navy-900">ซื่อสัตย์ต่องาน — งานต้องออกมาดี</h3>
    ...
    <div class="grid lg:grid-cols-5 gap-0">
      ...
      <div class="lg:col-span-3 p-8 lg:p-10 flex flex-col justify-center">
        ...
        <div class="mt-6 flex flex-wrap gap-2.5">
          <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[14px] text-ink2"><x-icon name="gear-wide-connected" class="text-accent" /> เริ่มจากเด็กติดรถ สู่ผู้ควบคุมเครื่องจักร</span>
          <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[14px] text-ink2"><x-icon name="mortarboard-fill" class="text-accent" /> เรียนรู้จากวิศวกรและผู้รับเหมาใหญ่</span>
          <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[14px] text-ink2"><x-icon name="buildings-fill" class="text-accent" /> รับเหมา {{ config('company.projects_completed') }} งาน</span>
          <span class="inline-flex items-center gap-2 rounded-full border border-line px-3.5 py-2 text-[14px] text-ink2"><x-icon name="patch-check-fill" class="text-accent" /> ไม่เคยทิ้งงาน</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="mx-auto max-w-7xl px-6 py-20 lg:py-24">
    <div class="grid lg:grid-cols-12 gap-12 items-center">
      <div class="lg:col-span-5">
        ...
        <a href="{{ route('frontend.services.index') }}" class="mt-7 inline-flex items-center gap-2 rounded-xl bg-hivis px-7 py-3.5 font-semibold text-navy-900 hover:bg-white transition">ดูบริการทั้งหมด <x-icon name="arrow-right" /></a>
      </div>
      <div class="lg:col-span-7 grid sm:grid-cols-2 gap-4">
        <div class="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6 hover:bg-white/10 transition">
          <span class="grid place-items-center w-12 h-12 rounded-xl bg-hivis/15 text-hivis text-2xl mb-4"><x-icon name="bricks" /></span>
        ...
        <div class="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6 hover:bg-white/10 transition">
          <span class="grid place-items-center w-12 h-12 rounded-xl bg-hivis/15 text-hivis text-2xl mb-4"><x-icon name="columns-gap" /></span>
          <div class="text-[13px] font-semibold text-hivis uppercase tracking-wide">แก้ปัญหา</div>
        ...
        <div class="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6 hover:bg-white/10 transition">
          <span class="grid place-items-center w-12 h-12 rounded-xl bg-hivis/15 text-hivis text-2xl mb-4"><x-icon name="truck" /></span>
          <div class="text-[13px] font-semibold text-hivis uppercase tracking-wide">แก้ปัญหา</div>
        ...
        <div class="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6 hover:bg-white/10 transition">
          <span class="grid place-items-center w-12 h-12 rounded-xl bg-hivis/15 text-hivis text-2xl mb-4"><x-icon name="lightning-charge-fill" /></span>
          <div class="text-[13px] font-semibold text-hivis uppercase tracking-wide">แก้ปัญหา</div>
...
{{-- ============ TESTIMONIALS ============ --}}
<x-frontend.testimonials class="border-t border-line" />

<!-- ===== CTA ===== -->
<section class="bg-navy-900 text-white">
  <div class="mx-auto max-w-7xl px-6 py-14 lg:py-16 flex flex-col lg:flex-row items-center justify-between gap-8">
    <div>
      <h2 class="lg:text-3xl font-bold tracking-tight">อยากได้ผู้รับเหมาที่รู้งานจริง คุยง่าย และไม่ทิ้งงาน?</h2>
