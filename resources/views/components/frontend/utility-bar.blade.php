<div class="hidden lg:block bg-navy-950 text-white/70 text-[13px]">
    <div class="mx-auto max-w-7xl px-6 h-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-6">
            ...
            <a href="tel:{{ $contactPhone['phone'] }}" class="hover:text-white transition font-mono tabular-nums tracking-tight"><x-icon name="telephone-fill" class="text-hivis mr-1 inline-block" /> {{ $contactPhone['phone_formatted'] }}</a>
        </div>
    </div>
</div>
